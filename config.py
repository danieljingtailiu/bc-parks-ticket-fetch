...
SELECTED_PARK = 'joffre_lakes'  # Change this to 'golden_ears' or 'joffre_lakes'
...
# Bot Settings
SETTINGS = {
    'wait_timeout': 5 if TEST_MODE else 10,  # Shorter timeout for testing
...
TEST_SETTINGS = {
    ...
    'step_by_step': True,    # Pause between steps for manual verification
